...
hi DiffChange guifg=#282c34 ctermfg=236 guibg=#e5c07b ctermbg=180 gui=underline cterm=underline
...
hi BufferCurrentMod guifg=#98c379 ctermfg=114 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#50fa7b ctermfg=84 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi BufferVisible guifg=#5c6370 ctermfg=241 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#e5c07b ctermfg=180 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#61afef ctermfg=75 guibg=#1e1e1e ctermbg=234 gui=NONE cterm=NONE
hi BufferInactive guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi BufferInactiveMod guifg=#e5c07b ctermfg=180 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi BufferInactiveSign guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
